...
$this.select();}).triggerHandler('--init');if(browser.name=='ie'||browser.mobile)
$this.css('max-height','10em').css('overflow-y','auto');});var $menu=$('#menu');$menu.wrapInner('<div class="inner"></div>');$menu._locked=false;$menu._lock=function(){if($menu._locked)
...
$menu._hide();});})(jQuery);(function($){$.fn.navList=function(){var $this=$(this);$a=$this.find('a'),b=[];$a.each(function(){var $this=$(this),indent=Math.max(0,$this.parents('li').length-1),href=$this.attr('href'),target=$this.attr('target');b.push('<a '+
